...
Mergesort is \$O(n \log{n}) \$. But on second glance, it makes sense, as
...
the \(n^2\) term for small n. This is due to copying of lists (i.e.
mergesort(arr{[}:mid{]}) instead of just passing parameters i and mid
and mid and j when splitting the left half and right half of the arrays
in mergesort.
...
We create ten random arrays for each length n, ranging from array len=1
...
\end{Verbatim}
    ...
    \begin{figure}
\centering
\includegraphics{attachment:Screen\%20Shot\%202018-11-03\%20at\%208.28.22\%20PM.png}
...
around \texttt{len(n)=140}, meaning that we're switching too late. This
drop trend happens all the way to \texttt{Hybrid(k=60)}, so we infer
from this graph that the optimal switch spot k must be \textless{} 60.
So we should increase the resolution/decrease the interval size around k
\textless{} 60.

    \begin{figure}
\centering
\includegraphics{attachment:Screen\%20Shot\%202018-11-03\%20at\%209.40.03\%20PM.png}
...
This contradicts the hypothesis. Really strange!
    ...
    \begin{figure}
\centering
\includegraphics{attachment:Screen\%20Shot\%202018-11-03\%20at\%2010.28.47\%20PM.png}
...
\end{Verbatim}
    ...
    \begin{figure}
\centering
\includegraphics{attachment:Screen\%20Shot\%202018-11-03\%20at\%2010.16.12\%20PM.png}
...
I compared it to our Hybrid Algorithm just for kicks.
    ...
    \begin{figure}
\centering
\includegraphics{attachment:Screen\%20Shot\%202018-11-03\%20at\%2011.01.46\%20PM.png}
...
was faster for \(\gt 2^5\) insertions.
    ...
    \begin{figure}
\centering
\includegraphics{attachment:Screen\%20Shot\%202018-11-04\%20at\%203.17.58\%20PM.png}
...
the HW4 spec
    ...
    \begin{figure}
\centering
\includegraphics{attachment:Screen\%20Shot\%202018-11-04\%20at\%205.06.57\%20PM.png}
